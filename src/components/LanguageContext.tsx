...
const dictionary: Record<Language, Record<string, string>> = {
  TR: {
    ...
    "Loaded existing proposal for revision: {number}": "Revize edilecek teklif yüklendi: {number}",
    "Revise this proposal in the wizard": "Bu teklifi sihirbazda revize et",
    "Save as Draft": "Taslak Oluştur",
    "Saved as draft.": "Taslak olarak kaydedildi.",
    ...uiDictionaryTR,
  },
  EN: {
    // Sidebar
